...
describe('Uniswap Contract', async () => {
  ...
  it('  *** Check RemoveLiquidity ***  ', async () => {
    ...
    let uniswapV2PairAt = await uniswapV2Pair.connect(signer[0]).attach(pair);
    console.log(
      `Liquidity After Add Liquidity Function : ${await uniswapV2PairAt.balanceOf(
        signer[0].address
      )}`
    );
    ...
    console.log(
      `Reserve After Add Liquidity: ${await uniswapV2PairAt.getReserves()}`
    );
    await uniswapV2PairAt
      .connect(signer[0])
      .approve(uniswapV2Router02.target, liquidity);
    await uniswapV2Router02
      .connect(signer[0])
      .removeLiquidity(
        tokenA.target,
    ...
    console.log(
      `Liquidity After Remove Liquidity Function : ${await uniswapV2PairAt.balanceOf(
        signer[0].address
      )}`
    );
    console.log(
  ...
  it('  *** Check removeLiquidityETH ***  ', async () => {
    ...
    console.log(
      `Reserve After addLiquidityETH: ${await uniswapV2PairAt.getReserves()}`
    );
    await uniswapV2PairAt
      .connect(signer[0])
      .approve(uniswapV2Router02.target, liquidity);
    ...
    console.log(
      `Liquidity After removeLiquidityETH Function : ${await uniswapV2PairAt.balanceOf(
        signer[1].address
      )}`
    );
    console.log(
      `Reserve After removeLiquidityETH: ${await uniswapV2PairAt.getReserves()}`
    );
    //1724915257
    //1695971128
  });
