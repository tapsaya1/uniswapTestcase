...
const provider = new ethers.providers.JsonRpcProvider('https://eth-goerli.g.alchemy.com/v2/bKAcOsXTqHEINi8v0vhhgUIgRO3MyNPO');
...
const UniContract = new ethers.Contract('0xF4b4fd3F8EE28c851E5964c8Cfb52ebE577002bE',abi,provider);


const tokenAAddress = '0x482B2C3f154e54ba04f0Fb19dCe1c764764312fD';
const tokenAAbi = [
	{
		"inputs": [],
...
const tokenBAddress = '0xFD6AAB9cDC37bdFF600309730f85b11A00B63c82';


const tokenAContract = new ethers.Contract(tokenAAddress,tokenAAbi,provider);
const tokenBContract = new ethers.Contract(tokenBAddress,tokenAAbi,provider);
...
//   console.log(await tokenAContract.balanceOf('0xb90F789eD58e7cF3eFc0421Ed87bb79f53B0f984'));

await tokenAContract.connect(wallet).approve('0xF4b4fd3F8EE28c851E5964c8Cfb52ebE577002bE',TOKEN_A_AMOUNT);
await tokenBContract.connect(wallet).approve('0xF4b4fd3F8EE28c851E5964c8Cfb52ebE577002bE',TOKEN_A_AMOUNT);

  await UniContract.connect(wallet).addLiquidity(tokenAAddress,tokenBAddress,TOKEN_A_AMOUNT,TOKEN_A_AMOUNT,1,1,wallet.address,1764541741,{gasLimit:500000});
